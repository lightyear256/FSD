...
<div className="flex flex-wrap items-center justify-center gap-x-2">
  <BlurText
    ...
    animateBy="words"
    direction="top"
    className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold mb-4"
  />
  ...
  <BlurText
    ...
    animateBy="words"
    direction="top"
    className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold mb-4 text-blue-500"
  />
</div>
